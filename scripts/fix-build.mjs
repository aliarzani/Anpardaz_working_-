...
if (!m.includes("receiptAndHomePolish")) {
  m = m.replace("import { installTransferEnhancements } from './features/transferEnhancements'", "import { installTransferEnhancements } from './features/transferEnhancements'\nimport { installReceiptAndHomePolish } from './features/receiptAndHomePolish'");
  m = m.replace('installTransferEnhancements()','installTransferEnhancements()\ninstallReceiptAndHomePolish()');
