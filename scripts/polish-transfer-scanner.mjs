...
s=s.replace('width:"42px",height:"42px"','width:"38px",height:"38px"');
s=s.replace('borderRadius:"12px",background:"rgba(0,214,176,.10)"','borderRadius:"10px",background:"rgba(0,214,176,.10)"');
s=s.replace("font-size:20px">اسکن بارکد کارت مقصد","font-size:19px">اسکن بارکد کارت مقصد");
s=s.replace('b.innerHTML="<span style=\'font-size:19px;line-height:1\'>⌗</span>"','b.innerHTML="<span style=\'font-size:18px;line-height:1\'>▣</span>"');
